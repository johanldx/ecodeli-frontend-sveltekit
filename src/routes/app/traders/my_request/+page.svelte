<script lang="ts">
	...
	onMount(() => onDestroy(tabTitle('app.traders.my_requests')));
	...
	const announcements = [
		{
			...
			type: 'Commerçant',
			price: '4,20 €',
			title: 'Livraison à moins de 10 km',
			description: 'Livraison de produit frais de notre boutique vers le client (3KM).',
			image: null
		},
		{
			id: 2,
