...
<div class="bg-base-200 font-author flex min-h-screen flex-col items-start p-6">
	<div class="w-full max-w-7xl">
		<h1 class="font-author mb-4 text-2xl">{$titles}</h1>
		...
		<div class="flex justify-between space-x-6">
			<div class="flex w-2/3 flex-col space-y-1 rounded-lg bg-white p-4 shadow-md">
				...
				<textarea class="textarea textarea-bordered w-1/2 rounded-md" bind:value={address}
				></textarea>
				...
				<div class="flex items-center space-x-2">
					...
					<input
						type="text"
						class="input input-bordered w-1/2 rounded-md"
						bind:value={image}
						readonly
					/>
				</div>
			...
			<div class="flex w-2/3 flex-col space-y-6">
				<div class="flex flex-col space-y-4 rounded-lg bg-white p-6 shadow-md">
