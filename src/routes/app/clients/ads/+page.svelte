...
const modify = t('app.clients.ads.modify');
const cancel = t('app.clients.ads.cancel');
const details = t('app.clients.ads.details');
const add_new_ads = t('app.clients.ads.add_new_ads');
