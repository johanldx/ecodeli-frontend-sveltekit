...
<GuardWrapper>
    <div class="text-center">
        ...
        <div class="my-5 space-y-5">
            <a href="/auth/space/clients" class="btn {hasClientProfile ? 'btn-primary' : 'border-primary'} w-full">{$client_label}</a>
            <a href="/auth/space/delivery-persons" class="btn {hasDeliveryProfile ? 'btn-primary' : 'border-primary'} w-full">{$delivery_label}</a>
            <a href="/auth/space/traders" class="btn {hasMerchantProfile ? 'btn-primary' : 'border-primary'} w-full">{$merchant_label}</a>
            <a href="/auth/space/providers" class="btn {hasServiceProviderProfile ? 'btn-primary' : 'border-primary'} w-full">{$service_provider_label}</a>
